---
title: "macOS 26 でターミナル配下の外付けボリュームが突然 Operation not permitted になる（設定は許可のまま）"
emoji: "💽"
type: "tech"
topics: ["macos", "ghostty", "terminal", "tcc", "claudecode"]
published: true
---
...
![システム設定のプライバシーとセキュリティ「ファイルとフォルダ」で Ghostty.app を開いたところ。フォルダ別のトグルが並ばず、「フルディスクアクセス」の 1 行だけが表示されている](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/09-09-macos26-files-folders-ghostty-fda.webp)
